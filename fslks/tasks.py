...
def register_task_mappings():
    ...
    sink.register('abstract_abstract',
                  input=sink.Join([
                      sink.Constant('biocontradictions_abstracts'),
                      sink.Constant('passage 1:'),
                      sink.Feature('text1'),
                      sink.Constant('passage 2:'),
                      sink.Feature('text2')
                  ]),
                  target=sink.LabelSwitch('label', {
                      0: sink.Constant('True'),
    ...
    sink.register('sentence_sentence',
                  input=sink.Join([
                      sink.Constant('biocontradictions_abstracts'),
                      sink.Constant('passage 1:'),
                      sink.Feature('text1'),
    ...
    sink.register('rank_predict',
                  input=sink.Join([
                      sink.Constant('bio contradiction'),
                      sink.Constant('premise question:'),
                      sink.Feature('question'),
                      sink.Constant('abstract text:'),
                      sink.Feature('text')
                  ]),
                  target=sink.Join([
    ...
    #               input=sink.Join([
    #                   sink.Constant('mnli'),
    #                   sink.Constant('hypothesis:'),
    #                   sink.Feature('hypothesis'),
    #                   sink.Constant('premise:'),
    #                   sink.Feature('premise')
    #               ]),
    #               target=sink.LabelSwitch('label', {
    #                   0: sink.Constant('entailment'),
    #                   1: sink.Constant('not_entailment'),
    #                   2: sink.Constant('contradiction')
    #               }))
